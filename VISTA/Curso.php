...
<button class="btn btn-primary glyphicon glyphicon-file" data-toggle="modal" data-target="#RegistrarClienteModal	" id="Agregar"> AGREGAR</button> 
 ...
 <table class="table">
    ...
    <tbody class="Contenido">
     ...
     <?php
     	include '../FUNCIONES/TablaCursos.php';
     ?>
...
<div id="RegistrarClienteModal" class="modal fade" role="dialog">
 ...
 <h4 class="modal-title">Agregar Cusrso</h4>
 </div>
...
<select class="form-control" name="Estado" id="Estado">
 ...
 <button  class="btn btn-primary Registrar" type="submit" value="Insertar" name="Inserta" id="Inserta">Registrar</button>
  <button type="submit" class="btn btn-success Actualizar nover glyphicon glyphicon-pencil"  value="Actualizar" name="Actualizar" id="Actualizar ">Actualizar</button>
 </div>
		</form > 
		<?php
...
$sql="INSERT INTO cursos VALUES(0, '$Nombre', '$Estado') ";
...
$Estado=$_POST['Estado'];
							...
							$conexion = mysql_connect('localhost:3306', 'root','');
mysql_select_db ('prueba', $conexion); 
$sql="UPDATE cursos SET curso='$Nombre', estado_curso = '$Estado' where codigo_curso=$id ";
